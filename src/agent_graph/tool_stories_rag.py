...
class StoriesRAGTool:
    ...
    This tool leverages a pre-trained Ollama embedding model to transform user queries into vector embeddings.
    ...
    Attributes:
        embedding_model (str): The name of the Ollama embedding model used for generating vector representations of queries.
    ...
    def __init__(self, embedding_model: str, vectordb_dir: str, k: int, collection_name: str) -> None:
        ...
        Args:
            embedding_model (str): The name of the embedding model (e.g., "nomic-embed-text")
